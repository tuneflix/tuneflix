        ...
        {imdbLoading ? (
          ...
          <div className="movie-media-info">
            ...
            <div className="song-cont">
              <h3 className="songs-label">
                Songs from <br /> {movName}
              </h3>
              {songResults.length > 0 ? (
                <SongCard songResults={songResults} />
              ) : (
                <p className="no-results">
                  Due to limited trial data - no songs available at this time,
...
export default connect(
  mapStateToProps,
  { getMovies, getMovieImdb, getMovieSongs }
)(Movie);
